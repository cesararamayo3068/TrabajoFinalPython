const { createApp } = Vue
  ...
  createApp({
    data() {
      return {
        url:"https://24169grupo5.pythonanywhere.com/productos", // Retorna todos los registro de la tabla productos
        productos:[],
        error:false,
        cargando:true
      }
    ...
    methods: {
        ...
        eliminar(id) {
            ...
            const url = 'https://24169grupo5.pythonanywhere.com/borrar/'+id;
            var options = {
                method: 'DELETE',
